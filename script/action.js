$(document).ready(function(){
    ...
    $('header .lnb').each(function(){
        ...
        $('header .lnb_bg').height(gnbH + maxLnbH);
    });
    $('header .lnb').height(maxLnbH);

    $('header .gnb').mouseenter(function(){
        $('header .lnb, header .lnb_bg').fadeIn(250)
    })
    $('header .gnb').mouseleave(function(){
        $('header .lnb, header .lnb_bg').fadeOut(250)
    })
...
//         $('.road .doro').css({strokeDashoffset: 5200 - winScr - winHalfH + part1Top})
//     })
// });
